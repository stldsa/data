...
zip_geojson = dl.GeoJSON(data=geojson_data,  # url to geojson file
...
city_map = html.Div(
    dl.Map(children=[mapping.get_base_toner_tile_layer(), zip_geojson, colorbar], zoom=12, center=stl_center), 
